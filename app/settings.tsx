...
export default function SettingsScreen(): React.JSX.Element {
  ...
  const { t } = useI18n(); const [hex, setHex] = useState(preferences.customAccent ?? "");
