...
const dictionaries = {
  en: {
    ...
    styleDefault: "Refined", styleFrosted: "Frosted glass", styleLiquid: "Liquid glass", styleMiui: "MIUI",
  ...
  "zh-CN": {
    ...
    styleDefault: "精致默认", styleFrosted: "极致毛玻璃", styleLiquid: "液态玻璃", styleMiui: "MIUI",
  ...
  ja: {
    ...
    styleDefault: "洗練", styleFrosted: "フロストガラス", styleLiquid: "リキッドガラス", styleMiui: "MIUI",
