...
const dictionaries = {
  en: {
    ...
    closePlayer: "Close", nothingPlaying: "Nothing is playing", backToHome: "Back to home", nowPlaying: "NOW PLAYING", playerLabel: "PLAYER", comments: "Comments", addFavorite: "Add to favorites", removeFavorite: "Remove from favorites",
  ...
  "zh-CN": {
    ...
    closePlayer: "关闭", nothingPlaying: "当前没有播放内容", backToHome: "返回首页", nowPlaying: "正在播放", playerLabel: "播放器", comments: "评论", addFavorite: "收藏", removeFavorite: "取消收藏",
  ...
  ja: {
    ...
    closePlayer: "閉じる", nothingPlaying: "再生中の曲はありません", backToHome: "ホームへ戻る", nowPlaying: "再生中", playerLabel: "プレーヤー", comments: "コメント", addFavorite: "お気に入りに追加", removeFavorite: "お気に入りから削除",
